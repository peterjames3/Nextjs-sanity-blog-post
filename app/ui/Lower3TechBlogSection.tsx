...
export default function Lower3TechBlogSection({techPosts =[]} :{techPosts : SanityDocument[]}){
    return(
        <figure>
            {techPosts.slice(4, 5).map((techPost) => (
            <div key={techPost._id}>
              ...
              <Image
                ...
                alt={techPost.title ||"alternative image title"}
                width={800}
                height={380}
