...
export default function MainLeftTechBlogSection({techPosts =[]} :{techPosts : SanityDocument[]}){
    return(
        <figure>
            {techPosts.slice(0, 1).map((techPost) => (
            <div key={techPost._id} className="min-h-[20rem]">
                {/* Mobile Image */}
              <Image
                src={builder
              ...
              <Image
                src={builder
                  ...
                  .height(380)
                  .url() ||"/3d-view-personal-computer-with-vegetation.jpg"}
                alt={techPost.title ||"Untitle Imaged"}
                objectFit='cover'
                fill={true}
