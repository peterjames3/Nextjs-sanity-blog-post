...
//  let allPosts : SanityDocument[] = [];
//     try {
//         allPosts = await sanityFetch<SanityDocument[]>({
//           query: postsQuery,
//           retries: 5, // Optional: Number of retry attempts
//           delay: 5000, // Optional: Delay in milliseconds between retries
//         });
//       } catch (error) {
//         console.error(`Error Fetching healthWellnessPosts: ${error}`);
//       }
    ...
    return(
        ...
        <span className="text-xl text-gray-600 font-light">Exploring Stories That Resonate.</span>
      </header>
      <div className="">
